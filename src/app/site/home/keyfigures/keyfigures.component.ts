...
export class KeyfiguresComponent {
    @Input() Heading:any
    Listkeyfigures:any[]=[
      {id:1,Title:"100% SẢN PHẨM NỘI ĐỊA",Desc:"TIN CẬY HÀNG ĐẦU",Image:"keyfigures/keyfigures1.png"},
      {id:2,Title:"ĐỘT PHÁ",Desc:"CÔNG NGHỆ KÉP 2IN1",Image:"keyfigures/keyfigures2.png"},
