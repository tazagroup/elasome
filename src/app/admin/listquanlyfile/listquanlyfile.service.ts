...
export class QuanlyfilesService {
  ...
  ListQuanlyfile = signal<any[]>([]);
  Quanlyfile = signal<any>({});
  async getAllQuanlyfile() {
    try {
      const options = {
        method: 'GET',
        headers: {
  ...
  async SearchQuanlyfile(SearchParams:any) {
    try {
      const options = {
        method:'POST',
        headers: {
  ...
  async getQuanlyfileByid(id: any) {
    try {
      const options = {
        method: 'GET',
        headers: {
  ...
  async updateOneQuanlyfile(dulieu: any) {
    try {
      const options = {
          method:'PATCH',
          headers: {
  ...
  async DeleteQuanlyfile(item:any) {    
    try {
        const options = {
            method:'DELETE',
            headers: {
