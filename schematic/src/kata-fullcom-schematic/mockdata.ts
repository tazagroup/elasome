...
export function createMockDataFiles(tree: Tree, currentPath: string, fileName: string) {
  tree.create(
    `${currentPath}/list${fileName}/list${fileName}.ts`,
    `export const List${capitalize(fileName)}:any[]=[
    {
